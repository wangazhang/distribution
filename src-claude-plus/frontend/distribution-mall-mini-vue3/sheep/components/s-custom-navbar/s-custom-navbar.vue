        ...
        <view class="nav-icon" v-if="showLeftButton">
          <view class="icon-box ss-flex" :class="{ 'inner-icon-box': data.styleType === 'inner' }">
            <view
              ...
              hover-class="icon-button-hover-left"
              hover-stay-time="80"
              @tap="onClickLeft"
            >
            ...
            <view
              ...
              hover-class="icon-button-hover-right"
              hover-stay-time="80"
              @tap="onClickRight"
            >
...
<script setup>
  ...
  // 左侧按钮：智能返回（优先返回到"我的页面"）
  function onClickLeft() {
    sheep.$router.smartBack();
  }
...
<style lang="scss">
  ...
  .icon-button-hover-right {
    background: rgba(0, 0, 0, 0.16) !important;
    border-radius: 0 30rpx 30rpx 0 !important;
  }
</style>
