  ...
  export default {
    ...
    methods: {
      ...
      async setValue(newVal, oldVal) {
        ...
        console.log('[s-uploader][setValue] incoming:', newVal);
        ...
        console.log('[s-uploader][setValue] files initialized:', this.files);
      },
       ...
       */
      delFile(index) {
        console.log('[s-uploader][delFile] before delete index=', index, this.files);
        this.$emit('delete', {
        ...
        console.log('[s-uploader][delFile] after delete files=', this.files);
      },
      ...
      setEmit() {
        let data = [];
        let updateUrl = [];
        console.log('[s-uploader][setEmit] current files:', this.files);
        if (this.returnType === 'object') {
        ...
        console.log('[s-uploader][setEmit] emit modelValue=', this.localValue, 'url=', updateUrl);
      },
