...
const handleCreated = (editor: IDomEditor) => {
  ...
  // 注册自定义图库选择功能
  registerImageGallerySelector(editor)
}
...
const editorConfig = computed((): IEditorConfig => {
  ...
  return Object.assign(baseConfig, props.editorConfig || {})
})
...
// 注册图库选择器
const registerImageGallerySelector = (editor: IDomEditor) => {
  console.log('Registering image gallery selector for editor:', editor)
  // 注册图库选择功能到编辑器实例
  ;(editor as any).showImageGallery = () => {
    console.log('showImageGallery called')
...
<template>
  <div class="border-1 border-solid border-[var(--tags-view-border-color)] z-10">
    ...
    <ImageGallerySelector
      v-model="gallerySelectorVisible"
      :multiple="true"
