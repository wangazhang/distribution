    ...
    <el-form label-width="80px" :model="formData">
      <el-card header="样式设置" class="property-group" shadow="never">
        ...
        <el-form-item label="高度" prop="height">
          <el-input-number v-model="formData.height" :min="100" :max="500" :step="10" style="width: 120px;" />
          <el-text type="info" class="m-l-8px">单位：px</el-text>
        </el-form-item>
        <el-form-item label="中间突出" prop="centerHighlight">
          <el-switch v-model="formData.centerHighlight" />
          <el-text type="info" class="m-l-8px">启用后轮播图中间会突出显示</el-text>
        </el-form-item>
        <el-form-item label="图片适配" prop="objectFit">
          <el-radio-group v-model="formData.objectFit">
