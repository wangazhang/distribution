...
export interface CarouselProperty {
  ...
  // 图片适配模式：fill（填充） | contain（等比例缩放，确保图片完全显示） | cover（等比例缩放，确保充满容器）
...
export const component = {
  ...
  property: {
    ...
    interval: 3,
    items: [
      { type: 'img', imgUrl: 'https://static.example.com/mall/banner-01.jpg', videoUrl: '' },
      { type: 'img', imgUrl: 'https://static.example.com/mall/banner-02.jpg', videoUrl: '' }
