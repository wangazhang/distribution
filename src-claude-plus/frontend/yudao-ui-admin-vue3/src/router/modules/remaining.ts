...
const remainingRouter: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'policy',
        component: () => import('@/views/mb/commission/policy/index.vue'),
        name: 'MbCommissionPolicy',
        meta: {
          hidden: true,
          canTo: true,
          icon: 'ep:collection',
      ...
      },
      {
        ...
        component: () => import('@/views/mb/commission/policy/Simulator.vue'),
        name: 'MbCommissionSimulator',
        meta: {
          hidden: true,
          canTo: true,
          activeMenu: '/mb/commission/policy',
          title: '分佣模拟器'
        }
      }
    ]
  ...
  {
    path: '/mb/material-restock-price',
    component: Layout,
    name: 'MbMaterialRestockPriceRoot',
    meta: {
      hidden: true
    },
    children: [
      {
        path: 'list',
        component: () => import('@/views/mb/materialRestockPrice/index.vue'),
        name: 'MbMaterialRestockPrice',
        meta: {
          hidden: true,
          canTo: true,
          title: '补货价格配置'
