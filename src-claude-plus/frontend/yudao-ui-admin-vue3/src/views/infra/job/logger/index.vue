<template>
  <doc-alert title="定时任务" url="https://doc.example.com/job/" />
  <doc-alert title="异步任务" url="https://doc.example.com/async-task/" />
  <doc-alert title="消息队列" url="https://doc.example.com/message-queue/" />
