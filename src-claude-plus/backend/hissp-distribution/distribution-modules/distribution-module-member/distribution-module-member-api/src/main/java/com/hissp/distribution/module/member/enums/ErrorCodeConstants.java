package com.hissp.distribution.module.member.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 用户身份认证 1-004-002-000 ==========
    ErrorCode USER_IDENTITY_NOT_EXISTS = new ErrorCode(1_004_002_000, "用户身份认证信息不存在");
    ErrorCode USER_IDENTITY_ALREADY_EXISTS = new ErrorCode(1_004_002_001, "用户身份认证信息已存在");
    ErrorCode USER_IDENTITY_ID_CARD_ALREADY_USED = new ErrorCode(1_004_002_002, "身份证号已被其他用户使用");
