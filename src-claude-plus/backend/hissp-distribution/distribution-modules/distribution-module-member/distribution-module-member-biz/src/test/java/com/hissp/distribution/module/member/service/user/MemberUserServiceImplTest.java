...
import com.hissp.distribution.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.hissp.distribution.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, DistributionRedisAutoConfiguration.class})
