package com.hissp.distribution.module.member.controller.app.social;
...
import com.hissp.distribution.module.member.controller.app.social.vo.*;
...
public class AppSocialUserController {
    ...
    @PostMapping("/bind")
    @Operation(summary = "绑定社交id与成员id，使用 code 授权码")
    @PermitAll
