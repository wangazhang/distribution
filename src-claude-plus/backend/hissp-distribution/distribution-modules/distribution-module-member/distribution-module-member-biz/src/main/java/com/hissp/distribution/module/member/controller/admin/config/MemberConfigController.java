package com.hissp.distribution.module.member.controller.admin.config;

import com.hissp.distribution.framework.common.pojo.CommonResult;
import com.hissp.distribution.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.hissp.distribution.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.hissp.distribution.module.member.convert.config.MemberConfigConvert;
import com.hissp.distribution.module.member.dal.dataobject.config.MemberConfigDO;
import com.hissp.distribution.module.member.service.config.MemberConfigService;
