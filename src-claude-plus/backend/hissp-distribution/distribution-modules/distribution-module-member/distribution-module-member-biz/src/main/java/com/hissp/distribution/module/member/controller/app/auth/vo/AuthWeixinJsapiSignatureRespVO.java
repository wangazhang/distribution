package com.hissp.distribution.module.member.controller.app.auth.vo;
...
public class AuthWeixinJsapiSignatureRespVO {
    ...
    @Schema(description = "URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.example.com")
    private String url;
