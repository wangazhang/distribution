package com.hissp.distribution.module.member.controller.app.social.vo;
...
public class AppSocialUserRespVO {
    ...
    @Schema(description = "社交用户的头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.example.com/1.png")
