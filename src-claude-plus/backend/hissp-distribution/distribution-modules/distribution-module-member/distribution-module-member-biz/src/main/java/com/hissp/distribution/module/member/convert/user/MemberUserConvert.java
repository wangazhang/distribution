package com.hissp.distribution.module.member.convert.user;

import com.hissp.distribution.framework.common.pojo.PageResult;
import com.hissp.distribution.module.member.api.user.dto.MemberUserRespDTO;
import com.hissp.distribution.module.member.controller.admin.user.vo.MemberUserRespVO;
import com.hissp.distribution.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import com.hissp.distribution.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
...
public interface MemberUserConvert {
    ...
    List<MemberUserRespVO> convertList03(List<MemberUserDO> list);
