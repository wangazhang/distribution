package com.hissp.distribution.module.mp.service.account;
...
import com.hissp.distribution.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.hissp.distribution.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.hissp.distribution.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.hissp.distribution.module.mp.convert.account.MpAccountConvert;
import com.hissp.distribution.module.mp.dal.dataobject.account.MpAccountDO;
import com.hissp.distribution.module.mp.dal.mysql.account.MpAccountMapper;
import com.hissp.distribution.module.mp.enums.ErrorCodeConstants;
...
import static com.hissp.distribution.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 distribution-module-mp - 表结构未导入][参考 https://doc.example.com/mp/build/ 开启]");
            }
