package com.hissp.distribution.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.hissp.distribution.framework.common.pojo.PageResult;
import com.hissp.distribution.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import com.hissp.distribution.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.hissp.distribution.module.mp.convert.message.MpMessageConvert;
import com.hissp.distribution.module.mp.dal.dataobject.account.MpAccountDO;
import com.hissp.distribution.module.mp.dal.dataobject.message.MpMessageDO;
import com.hissp.distribution.module.mp.dal.dataobject.user.MpUserDO;
import com.hissp.distribution.module.mp.dal.mysql.message.MpMessageMapper;
import com.hissp.distribution.module.mp.enums.message.MpMessageSendFromEnum;
import com.hissp.distribution.module.mp.framework.mp.core.MpServiceFactory;
import com.hissp.distribution.module.mp.framework.mp.core.util.MpUtils;
import com.hissp.distribution.module.mp.service.account.MpAccountService;
import com.hissp.distribution.module.mp.service.material.MpMaterialService;
import com.hissp.distribution.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.hissp.distribution.module.mp.service.user.MpUserService;
...
import static com.hissp.distribution.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
