package com.hissp.distribution.module.mp.controller.admin.menu.vo;
...
import static com.hissp.distribution.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.example.com/")
