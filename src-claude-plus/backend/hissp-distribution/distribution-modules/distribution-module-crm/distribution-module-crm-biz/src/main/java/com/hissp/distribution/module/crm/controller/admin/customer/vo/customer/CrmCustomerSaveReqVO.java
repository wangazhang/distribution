package com.hissp.distribution.module.crm.controller.admin.customer.vo.customer;

import com.hissp.distribution.framework.common.validation.InEnum;
import com.hissp.distribution.framework.common.validation.Mobile;
import com.hissp.distribution.framework.common.validation.Telephone;
import com.hissp.distribution.framework.excel.core.annotations.DictFormat;
import com.hissp.distribution.module.crm.enums.customer.CrmCustomerLevelEnum;
import com.hissp.distribution.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import com.hissp.distribution.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import com.hissp.distribution.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import com.hissp.distribution.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static com.hissp.distribution.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
...
public class CrmCustomerSaveReqVO {
    ...
    @Schema(description = "邮箱", example = "123456789@example.com")
