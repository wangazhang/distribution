package com.hissp.distribution.module.product.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode SKU_MEMBER_PRICE_LEVEL_DUPLICATE = new ErrorCode(1_008_006_005, "商品 SKU 会员价存在重复的会员等级配置");
    ErrorCode SKU_MEMBER_PRICE_INVALID = new ErrorCode(1_008_006_006, "商品 SKU 会员价必须大于等于 0");
    ...
    // ========== 商品-套包 packagex 1-008-020-000 ==========
    ErrorCode PRODUCT_PACKAGE_NOT_EXISTS = new ErrorCode(1_008_020_000, "套包不存在");
    ErrorCode PRODUCT_PACKAGE_ONLY_ONE_ENABLED_PER_SPU = new ErrorCode(1_008_020_001, "同一 SPU 仅允许一个启用的套包");
    ErrorCode PRODUCT_PACKAGE_ITEMS_EMPTY = new ErrorCode(1_008_020_002, "物料明细不能为空");
    ErrorCode PRODUCT_PACKAGE_SET_LEVEL_NEED_LEVEL_ID = new ErrorCode(1_008_020_003, "SET_LEVEL 需携带 extJson.levelId");
    ErrorCode PRODUCT_PACKAGE_LEVEL_NOT_EXISTS = new ErrorCode(1_008_020_004, "指定的会员等级不存在");
    ErrorCode PRODUCT_PACKAGE_COMMISSION_LEVEL_DUPLICATE = new ErrorCode(1_008_020_005, "每个层级的分佣规则最多一条");
    ErrorCode PRODUCT_PACKAGE_COMMISSION_RATIO_BASE_INVALID = new ErrorCode(1_008_020_006, "自定义基准的比例分佣, 基准金额必须大于0");
    ErrorCode PRODUCT_PACKAGE_MATERIAL_DEFINITION_NOT_EXISTS = new ErrorCode(1_008_020_007, "商品 SPU【{}】未配置物料定义");
    ErrorCode PRODUCT_PACKAGE_MATERIAL_DEFINITION_DISABLED = new ErrorCode(1_008_020_008, "商品 SPU【{}】的物料定义未启用");
}
