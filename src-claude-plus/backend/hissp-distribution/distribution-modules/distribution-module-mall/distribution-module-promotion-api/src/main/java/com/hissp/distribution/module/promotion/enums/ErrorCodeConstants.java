package com.hissp.distribution.module.promotion.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== CMS板块 1-013-021-000 ==========
    ErrorCode CMS_SECTION_NOT_EXISTS = new ErrorCode(1_013_021_000, "CMS板块不存在");

    // ========== CMS分类 1-013-022-000 ==========
    ErrorCode CMS_CATEGORY_NOT_EXISTS = new ErrorCode(1_013_022_000, "CMS分类不存在");
    ErrorCode CMS_CATEGORY_HAS_ARTICLES = new ErrorCode(1_013_022_001, "分类下存在文章，不能删除");

    // ========== CMS标签 1-013-023-000 ==========
    ErrorCode CMS_TAG_NOT_EXISTS = new ErrorCode(1_013_023_000, "CMS标签不存在");
    ErrorCode CMS_TAG_NAME_EXISTS = new ErrorCode(1_013_023_001, "标签名称已存在");
    ErrorCode CMS_TAG_HAS_ARTICLES = new ErrorCode(1_013_023_002, "标签下存在文章，不能删除");

    // ========== CMS文章 1-013-024-000 ==========
    ErrorCode CMS_ARTICLE_NOT_EXISTS = new ErrorCode(1_013_024_000, "CMS文章不存在");
    ErrorCode CMS_ARTICLE_ALREADY_PUBLISHED = new ErrorCode(1_013_024_001, "文章已发布，不能修改");
    ErrorCode CMS_ARTICLE_AUDIT_STATUS_NOT_PENDING = new ErrorCode(1_013_024_002, "文章非待审核状态，不能审核");
    ErrorCode CMS_ARTICLE_NOT_APPROVED = new ErrorCode(1_013_024_003, "文章未通过审核，不能发布");

    // ========== CMS用户行为 1-013-025-000 ==========
    ErrorCode CMS_USER_ACTION_EXISTS = new ErrorCode(1_013_025_000, "用户已执行过该操作");

    // ========== CMS文章评论 1-013-026-000 ==========
    ErrorCode CMS_ARTICLE_COMMENT_NOT_EXISTS = new ErrorCode(1_013_026_000, "评论不存在");
    ErrorCode CMS_ARTICLE_COMMENT_NOT_OWNER = new ErrorCode(1_013_026_001, "不能删除他人的评论");
