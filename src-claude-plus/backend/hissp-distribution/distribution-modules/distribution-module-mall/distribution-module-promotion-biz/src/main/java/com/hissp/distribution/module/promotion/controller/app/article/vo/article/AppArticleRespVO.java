package com.hissp.distribution.module.promotion.controller.app.article.vo.article;
...
public class AppArticleRespVO {
    ...
    @Schema(description = "图文封面", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.example.com/1.png")
