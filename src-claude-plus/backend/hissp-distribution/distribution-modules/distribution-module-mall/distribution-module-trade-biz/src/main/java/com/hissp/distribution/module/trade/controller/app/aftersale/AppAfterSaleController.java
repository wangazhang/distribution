package com.hissp.distribution.module.trade.controller.app.aftersale;
...
public class AppAfterSaleController {
    ...
    public CommonResult<Long> createAfterSale(@RequestBody @Validated AppAfterSaleCreateReqVO createReqVO) {
