...
public class BrokerageRecordPageReqVO extends PageParam {
    ...
    @Schema(description = "业务编号", example = "10086")
    ...
    @Schema(description = "是否包含平台账户数据", example = "false")
    private Boolean includePlatformAccount;

    @Schema(description = "是否包含总部账户数据", example = "false")
    private Boolean includeHqAccount;
