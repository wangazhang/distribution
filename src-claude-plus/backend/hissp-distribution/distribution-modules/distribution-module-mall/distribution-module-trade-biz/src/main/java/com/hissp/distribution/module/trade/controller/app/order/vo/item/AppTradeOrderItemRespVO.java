package com.hissp.distribution.module.trade.controller.app.order.vo.item;
...
public class AppTradeOrderItemRespVO {
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.example.com/1.png")
