package com.hissp.distribution.module.product.controller.app.history.vo;
...
public class AppProductBrowseHistoryRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = REQUIRED, example = "https://www.example.com/pic.png")
