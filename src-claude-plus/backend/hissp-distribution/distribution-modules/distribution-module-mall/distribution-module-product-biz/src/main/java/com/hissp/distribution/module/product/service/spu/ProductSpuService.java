...
public interface ProductSpuService {
     ...
     * @return 商品 SPU 列表
     */
    List<ProductSpuDO> getSpuSimpleList(String name);
    ...
    Boolean isNoneMarketingProduct(List<Long> spuIds);

    Boolean isCareerProduct(List<Long> spuIds);

     Boolean isMbProduct(List<Long> spuIds);
}
