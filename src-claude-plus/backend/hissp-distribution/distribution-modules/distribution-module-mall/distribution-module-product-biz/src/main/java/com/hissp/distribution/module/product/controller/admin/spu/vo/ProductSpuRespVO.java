package com.hissp.distribution.module.product.controller.admin.spu.vo;
...
import com.hissp.distribution.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.example.com/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.example.com/xx.png, https://www.example.com/xxx.png]")
    private List<String> sliderPicUrls;

    @Schema(description = "商品类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @ExcelProperty(value = "商品类型", converter = DictConvert.class)
    @DictFormat(DictTypeConstants.PRODUCT_SPU_TYPE)
