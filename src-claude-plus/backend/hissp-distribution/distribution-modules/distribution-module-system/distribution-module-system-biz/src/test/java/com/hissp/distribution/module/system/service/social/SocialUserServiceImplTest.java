package com.hissp.distribution.module.system.service.social;
...
import com.hissp.distribution.module.system.controller.admin.socail.vo.user.SocialUserPageReqVO;
import com.hissp.distribution.module.system.dal.dataobject.social.SocialUserBindDO;
import com.hissp.distribution.module.system.dal.dataobject.social.SocialUserDO;
import com.hissp.distribution.module.system.dal.mysql.social.SocialUserBindMapper;
import com.hissp.distribution.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.hissp.distribution.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetSocialUserPage() {
        ...
        SocialUserDO dbSocialUser = randomPojo(SocialUserDO.class, o -> { // 等会查询到
            ...
            o.setNickname("芋艿");
            o.setOpenid("distributionyuanma");
