package com.hissp.distribution.module.system.service.tenant;

import com.hissp.distribution.framework.common.enums.CommonStatusEnum;
import com.hissp.distribution.framework.common.pojo.PageResult;
import com.hissp.distribution.framework.tenant.config.TenantProperties;
import com.hissp.distribution.framework.tenant.core.context.TenantContextHolder;
import com.hissp.distribution.framework.test.core.ut.BaseDbUnitTest;
import com.hissp.distribution.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.hissp.distribution.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.hissp.distribution.module.system.dal.dataobject.permission.MenuDO;
import com.hissp.distribution.module.system.dal.dataobject.permission.RoleDO;
import com.hissp.distribution.module.system.dal.dataobject.tenant.TenantDO;
import com.hissp.distribution.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.hissp.distribution.module.system.dal.mysql.tenant.TenantMapper;
import com.hissp.distribution.module.system.enums.permission.RoleCodeEnum;
import com.hissp.distribution.module.system.enums.permission.RoleTypeEnum;
import com.hissp.distribution.module.system.service.permission.MenuService;
import com.hissp.distribution.module.system.service.permission.PermissionService;
import com.hissp.distribution.module.system.service.permission.RoleService;
import com.hissp.distribution.module.system.service.tenant.handler.TenantInfoHandler;
import com.hissp.distribution.module.system.service.tenant.handler.TenantMenuHandler;
import com.hissp.distribution.module.system.service.user.AdminUserService;
...
import static com.hissp.distribution.framework.common.util.collection.SetUtils.asSet;
import static com.hissp.distribution.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.hissp.distribution.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static com.hissp.distribution.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.hissp.distribution.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsite("https://www.example.com");
            o.setUsername("yunai");
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://www.example.com"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.example.com");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
