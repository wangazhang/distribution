package com.hissp.distribution.module.system.service.user;
...
import com.hissp.distribution.framework.common.util.collection.ArrayUtils;
...
import com.hissp.distribution.module.infra.api.config.ConfigApi;
import com.hissp.distribution.module.infra.api.file.FileApi;
import com.hissp.distribution.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.hissp.distribution.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.hissp.distribution.module.system.controller.admin.user.vo.user.*;
import com.hissp.distribution.module.system.dal.dataobject.dept.DeptDO;
import com.hissp.distribution.module.system.dal.dataobject.dept.PostDO;
import com.hissp.distribution.module.system.dal.dataobject.dept.UserPostDO;
import com.hissp.distribution.module.system.dal.dataobject.tenant.TenantDO;
import com.hissp.distribution.module.system.dal.dataobject.user.AdminUserDO;
import com.hissp.distribution.module.system.dal.mysql.dept.UserPostMapper;
import com.hissp.distribution.module.system.dal.mysql.user.AdminUserMapper;
import com.hissp.distribution.module.system.enums.common.SexEnum;
import com.hissp.distribution.module.system.service.dept.DeptService;
...
import com.hissp.distribution.module.system.service.tenant.TenantService;
...
import static com.hissp.distribution.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("distributionyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("distributionyuanma");
        ...
        assertEquals("distributionyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("distributionyuanma"))).thenReturn("java");
