...
import com.hissp.distribution.framework.common.util.cache.CacheUtils;
...
import com.hissp.distribution.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hissp.distribution.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.hissp.distribution.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.hissp.distribution.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hissp.distribution.module.system.dal.dataobject.social.SocialClientDO;
import com.hissp.distribution.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${distribution.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${distribution.wxa-subscribe-message.miniprogram-state:formal}")
