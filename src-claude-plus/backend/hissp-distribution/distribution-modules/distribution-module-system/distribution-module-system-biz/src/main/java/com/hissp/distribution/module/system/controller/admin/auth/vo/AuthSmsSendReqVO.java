package com.hissp.distribution.module.system.controller.admin.auth.vo;
...
public class AuthSmsSendReqVO extends CaptchaVerificationReqVO {
    ...
    @Schema(description = "手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "distributionyuanma")
