...
@Schema(description = "管理后台 - 物料出库创建 Request VO")
@Data
public class MaterialOutboundCreateReqVO {
    ...
    private List<MaterialOutboundItemCreateReqVO> items;

    @Schema(description = "物料出库明细")
    @Data
    public static class MaterialOutboundItemCreateReqVO {
