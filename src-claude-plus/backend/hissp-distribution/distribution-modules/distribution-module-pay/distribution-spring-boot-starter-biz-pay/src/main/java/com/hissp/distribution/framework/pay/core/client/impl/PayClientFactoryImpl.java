...
import com.hissp.distribution.framework.pay.core.client.impl.alipay.*;
import com.hissp.distribution.framework.pay.core.client.impl.huifu.HuiWxLitePayClient;
import com.hissp.distribution.framework.pay.core.client.impl.mock.MockPayClient;
import com.hissp.distribution.framework.pay.core.client.impl.payease.PayeaseAccountPayClient;
import com.hissp.distribution.framework.pay.core.client.impl.payease.PayeaseAlipayPayClient;
import com.hissp.distribution.framework.pay.core.client.impl.payease.PayeaseWxLitePayClient;
import com.hissp.distribution.framework.pay.core.client.impl.payease.PayeaseWxNativePayClient;
import com.hissp.distribution.framework.pay.core.client.impl.weixin.*;
...
import static com.hissp.distribution.framework.pay.core.enums.channel.PayChannelEnum.*;
...
public class PayClientFactoryImpl implements PayClientFactory {
    ...
    public PayClientFactoryImpl() {
        ...
        // 汇付支付：微信小程序
        clientClass.put(HUIFU_WX_LITE, HuiWxLitePayClient.class);
        // 首信易支付客户端
        clientClass.put(PAYEASE_WX_LITE, PayeaseWxLitePayClient.class);
        clientClass.put(PAYEASE_WX_NATIVE, PayeaseWxNativePayClient.class);
        clientClass.put(PAYEASE_ALIPAY, PayeaseAlipayPayClient.class);
        clientClass.put(PAYEASE_ACCOUNT, PayeaseAccountPayClient.class);
    }
