...
public class WxBarPayClient extends AbstractWxPayClient {
    ...
    protected PayOrderInnerRespDTO doUnifiedOrderV2(PayOrderUnifiedInnerReqDTO reqDTO) throws WxPayException {
        ...
        for (int i = 1; i < Byte.MAX_VALUE; i++) {
            try {
                ...
                return PayOrderInnerRespDTO.successOf(response.getTransactionId(), response.getOpenid(), parseDateV2(response.getTimeEnd()),
    ...
    static String getAuthCode(PayOrderUnifiedInnerReqDTO reqDTO) {
