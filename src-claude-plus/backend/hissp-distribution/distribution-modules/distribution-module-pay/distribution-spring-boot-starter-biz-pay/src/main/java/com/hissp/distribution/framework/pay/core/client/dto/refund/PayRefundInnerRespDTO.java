package com.hissp.distribution.framework.pay.core.client.dto.refund;
 ...
 */
@Data
public class PayRefundInnerRespDTO {
    ...
    private PayRefundInnerRespDTO() {
    }

    /**
     * 创建【WAITING】状态的退款返回
     */
    public static PayRefundInnerRespDTO waitingOf(String channelRefundNo,
                                                  String outRefundNo, Object rawData) {
        PayRefundInnerRespDTO respDTO = new PayRefundInnerRespDTO();
     ...
     * 创建【SUCCESS】状态的退款返回
     */
    public static PayRefundInnerRespDTO successOf(String channelRefundNo, LocalDateTime successTime,
                                                  String outRefundNo, Object rawData) {
        PayRefundInnerRespDTO respDTO = new PayRefundInnerRespDTO();
     ...
     * 创建【FAILURE】状态的退款返回
     */
    public static PayRefundInnerRespDTO failureOf(String outRefundNo, Object rawData) {
     ...
     * 创建【FAILURE】状态的退款返回
     */
    public static PayRefundInnerRespDTO failureOf(String channelErrorCode, String channelErrorMsg,
                                                  String outRefundNo, Object rawData) {
        PayRefundInnerRespDTO respDTO = new PayRefundInnerRespDTO();
