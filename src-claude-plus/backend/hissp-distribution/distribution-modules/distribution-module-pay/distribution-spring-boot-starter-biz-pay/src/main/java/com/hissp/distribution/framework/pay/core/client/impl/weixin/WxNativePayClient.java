...
public class WxNativePayClient extends AbstractWxPayClient {
    ...
    @Override
    protected PayOrderInnerRespDTO doUnifiedOrderV2(PayOrderUnifiedInnerReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderInnerRespDTO.waitingOf(PayOrderDisplayModeEnum.QR_CODE.getMode(), response.getCodeUrl(),
                reqDTO.getOutTradeNo(), response);
    }

    @Override
    protected PayOrderInnerRespDTO doUnifiedOrderV3(PayOrderUnifiedInnerReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderInnerRespDTO.waitingOf(PayOrderDisplayModeEnum.QR_CODE.getMode(), response,
                reqDTO.getOutTradeNo(), response);
    }
