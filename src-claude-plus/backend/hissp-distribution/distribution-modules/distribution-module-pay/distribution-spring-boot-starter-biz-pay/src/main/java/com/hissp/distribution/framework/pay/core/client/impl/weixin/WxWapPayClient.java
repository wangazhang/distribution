...
public class WxWapPayClient extends AbstractWxPayClient {
    ...
    protected PayOrderInnerRespDTO doUnifiedOrderV2(PayOrderUnifiedInnerReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderInnerRespDTO.waitingOf(PayOrderDisplayModeEnum.URL.getMode(), response.getMwebUrl(),
    ...
    protected PayOrderInnerRespDTO doUnifiedOrderV3(PayOrderUnifiedInnerReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderInnerRespDTO.waitingOf(PayOrderDisplayModeEnum.URL.getMode(), response,
                reqDTO.getOutTradeNo(), response);
    }
