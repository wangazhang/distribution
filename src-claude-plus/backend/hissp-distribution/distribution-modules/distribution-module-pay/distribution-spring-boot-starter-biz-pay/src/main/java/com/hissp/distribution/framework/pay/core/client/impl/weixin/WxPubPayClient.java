...
public class WxPubPayClient extends AbstractWxPayClient {
    ...
    protected PayOrderInnerRespDTO doUnifiedOrderV2(PayOrderUnifiedInnerReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderInnerRespDTO.waitingOf(PayOrderDisplayModeEnum.APP.getMode(), toJsonString(response),
    ...
    static String getOpenid(PayOrderUnifiedInnerReqDTO reqDTO) {
