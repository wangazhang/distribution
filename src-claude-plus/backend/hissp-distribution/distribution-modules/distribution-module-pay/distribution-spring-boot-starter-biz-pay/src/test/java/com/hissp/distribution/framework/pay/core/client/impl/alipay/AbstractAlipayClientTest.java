...
import static com.hissp.distribution.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_PUBLIC_KEY;
...
public abstract class AbstractAlipayClientTest extends BaseMockitoUnitTest {
    ...
    public void testUnifiedRefund_success() throws AlipayApiException {
        ...
        // 准备请求参数
        PayRefundUnifiedInnerReqDTO refundReqDTO = randomPojo(PayRefundUnifiedInnerReqDTO.class, o -> {
        ...
        // 调用
        PayRefundInnerRespDTO resp = client.unifiedRefund(refundReqDTO);
        // 断言
    ...
    public void testUnifiedRefund_throwServiceException() throws AlipayApiException {
        ...
        // 准备请求参数
        String notifyUrl = randomURL();
        PayRefundUnifiedInnerReqDTO refundReqDTO = randomPojo(PayRefundUnifiedInnerReqDTO.class, o -> o.setNotifyUrl(notifyUrl));
    ...
    public void testUnifiedOrder_paramInvalidate() {
        ...
        String outTradeNo = randomString();
        String notifyUrl = randomURL();
        PayOrderUnifiedInnerReqDTO reqDTO = randomPojo(PayOrderUnifiedInnerReqDTO.class, o -> {
            o.setOutTradeNo(outTradeNo);
            o.setNotifyUrl(notifyUrl);
        });
    ...
    protected PayOrderUnifiedInnerReqDTO buildOrderUnifiedReqDTO(String notifyUrl, String outTradeNo, Integer price) {
        return randomPojo(PayOrderUnifiedInnerReqDTO.class, o -> {
            o.setOutTradeNo(outTradeNo);
            o.setNotifyUrl(notifyUrl);
            o.setPrice(price);
