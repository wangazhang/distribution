...
import com.hissp.distribution.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import com.hissp.distribution.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import com.hissp.distribution.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import com.hissp.distribution.framework.pay.core.client.impl.weixin.WxPubPayClient;
...
public class PayClientFactoryImplIntegrationTest {
    ...
    public void testCreatePayClient_WX_PUB_V2() {
        ...
        // 发起支付
        PayOrderUnifiedInnerReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
...
//        System.out.println(JsonUtils.toJsonString(result));
    ...
    private static PayOrderUnifiedInnerReqDTO buildPayOrderUnifiedReqDTO() {
