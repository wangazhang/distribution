...
public interface PayNotifyService {
     ...
     * @param dataId 数据编号
     */
    default void createPayNotifyTask(Integer type, Long dataId) {
     ...
     */
    void createPayNotifyTask(Integer type, Long dataId, Map<String, Object> extParams);

    /**
     * 执行回调通知
     *
     * 注意，该方法提供给定时任务调用。目前是 distribution-server 进行调用
     * @return 通知数量
     */
