package com.hissp.distribution.module.pay.service.channel;
...
import com.hissp.distribution.module.pay.controller.admin.channel.vo.PayChannelCreateReqVO;
import com.hissp.distribution.module.pay.controller.admin.channel.vo.PayChannelUpdateReqVO;
import com.hissp.distribution.module.pay.convert.channel.PayChannelConvert;
import com.hissp.distribution.module.pay.dal.dataobject.channel.PayChannelDO;
import com.hissp.distribution.module.pay.dal.mysql.channel.PayChannelMapper;
...
public class PayChannelServiceImpl implements PayChannelService {
    ...
    @Override
    public List<PayChannelDO> getChannelList(Long appId, Integer type) {
        return payChannelMapper.selectList(new LambdaQueryWrapperX<PayChannelDO>()
                .eq(PayChannelDO::getAppId, appId)
                .eq(type != null, PayChannelDO::getType, type));
    }
