package com.hissp.distribution.module.pay.controller.admin.app.vo;
...
public class PayAppBaseVO {
    ...
    @Schema(description = "应用标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "distribution")
    ...
    @Schema(description = "账户服务渠道编号", example = "188")
