package com.hissp.distribution.module.pay.controller.admin.transfer.vo;
...
public class PayTransferRespVO {
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.example.com")
