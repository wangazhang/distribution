package com.hissp.distribution.module.pay.controller.admin.channel;
...
import com.hissp.distribution.module.pay.controller.admin.channel.vo.PayChannelRespVO;
...
public class PayChannelController {
    ...
    public CommonResult<List<PayChannelRespVO>> getChannelList(@RequestParam("appId") Long appId,
        ...
        List<PayChannelDO> list = channelService.getChannelList(appId, type);
