package com.hissp.distribution.module.pay.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode APP_ACCOUNT_CHANNEL_NOT_SAME_APP = new ErrorCode(1_007_000_006, "账户服务渠道不属于当前应用");
    ErrorCode APP_ACCOUNT_CHANNEL_TYPE_ERROR = new ErrorCode(1_007_000_007, "请选择账户服务渠道类型的配置");
    ErrorCode APP_ACCOUNT_CHANNEL_NOT_CONFIG = new ErrorCode(1_007_000_008, "应用未配置账户服务渠道");
    ...
    ErrorCode CHANNEL_DECLARE_FAIL = new ErrorCode(1_007_001_005, "账户服务申报失败：{}");

    // ========== 提现资料 1-007-010-000 ==========
    ErrorCode SETTLE_ACCOUNT_NOT_FOUND = new ErrorCode(1_007_010_000, "请先完善提现资料");
    ErrorCode SETTLE_ACCOUNT_NOT_APPROVED = new ErrorCode(1_007_010_001, "提现资料尚未审核通过");
    ErrorCode SETTLE_ACCOUNT_CHANNEL_LOST = new ErrorCode(1_007_010_002, "渠道子商户编号不存在");

    // ========== 银行卡绑定模块 1-007-005-000 ==========
    ErrorCode PAY_BANKCARD_NOT_EXISTS = new ErrorCode(1_007_005_000, "银行卡不存在");
    ErrorCode PAY_BANKCARD_ALREADY_BOUND = new ErrorCode(1_007_005_001, "银行卡已经被绑定");
    ErrorCode PAY_BANKCARD_BIND_FAILED = new ErrorCode(1_007_005_002, "银行卡绑定失败");
    ErrorCode PAY_BANKCARD_UNBIND_FAILED = new ErrorCode(1_007_005_003, "银行卡解绑失败");

    // ========== 入网任务模块 1-007-006-000 ==========
    ErrorCode PAY_NETWORK_TASK_NOT_EXISTS = new ErrorCode(1_007_006_000, "入网任务不存在");
    ErrorCode PAY_NETWORK_TASK_STATUS_NOT_FAILED = new ErrorCode(1_007_006_001, "入网任务状态不是失败");
    ErrorCode PAY_NETWORK_TASK_PROCESS_FAILED = new ErrorCode(1_007_006_002, "入网任务处理失败");
    ErrorCode PAY_NETWORK_TASK_RETRY_LIMIT_EXCEEDED = new ErrorCode(1_007_006_003, "入网任务重试次数超限");
    ...
    ErrorCode PAY_ORDER_SUBMIT_CHANNEL_ERROR = new ErrorCode(1_007_002_004, "发起支付报错，错误提示：{}，错误码：{}");
    ErrorCode PAY_ORDER_REFUND_FAIL_STATUS_ERROR = new ErrorCode(1_007_002_005, "支付订单退款失败，原因：状态不是已支付或已退款");
    ErrorCode PAY_ORDER_CHANNEL_QUERY_UNSUPPORTED = new ErrorCode(1_007_002_006, "该支付订单不支持渠道查询");
    ErrorCode PAY_ORDER_CHANNEL_QUERY_EMPTY = new ErrorCode(1_007_002_007, "渠道未返回订单信息，请稍后重试");
    ...
    ErrorCode PAY_TRANSFER_CHANNEL_REQUEST_FAILED = new ErrorCode(1_007_009_007, "发起渠道转账失败，请稍后重试");
