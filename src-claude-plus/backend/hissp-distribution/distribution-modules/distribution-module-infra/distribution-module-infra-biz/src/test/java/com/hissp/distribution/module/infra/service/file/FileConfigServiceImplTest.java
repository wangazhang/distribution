package com.hissp.distribution.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.hissp.distribution.framework.common.pojo.PageResult;
import com.hissp.distribution.module.infra.framework.file.core.client.FileClient;
import com.hissp.distribution.module.infra.framework.file.core.client.FileClientConfig;
import com.hissp.distribution.module.infra.framework.file.core.client.FileClientFactory;
import com.hissp.distribution.module.infra.framework.file.core.client.local.LocalFileClient;
import com.hissp.distribution.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.hissp.distribution.module.infra.framework.file.core.enums.FileStorageEnum;
import com.hissp.distribution.framework.test.core.ut.BaseDbUnitTest;
import com.hissp.distribution.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.hissp.distribution.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.hissp.distribution.module.infra.dal.dataobject.file.FileConfigDO;
import com.hissp.distribution.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static com.hissp.distribution.framework.test.core.util.RandomUtils.randomLongId;
import static com.hissp.distribution.framework.test.core.util.RandomUtils.randomPojo;
import static com.hissp.distribution.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.hissp.distribution.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://doc.example.com").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://doc.example.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
