package com.hissp.distribution.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("distributionyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.distribution.example.com"); // 如果有自定义域名，则可以设置。http://static.distribution.example.com
        // 默认上海的 endpoint
