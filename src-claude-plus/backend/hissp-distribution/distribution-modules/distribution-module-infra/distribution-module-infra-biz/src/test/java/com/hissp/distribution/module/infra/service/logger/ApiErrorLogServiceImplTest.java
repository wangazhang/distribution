package com.hissp.distribution.module.infra.service.logger;
...
import com.hissp.distribution.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.hissp.distribution.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.hissp.distribution.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.hissp.distribution.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.hissp.distribution.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.hissp.distribution.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("distribution-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("distribution-test");
