package com.hissp.distribution.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.hissp.distribution.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
