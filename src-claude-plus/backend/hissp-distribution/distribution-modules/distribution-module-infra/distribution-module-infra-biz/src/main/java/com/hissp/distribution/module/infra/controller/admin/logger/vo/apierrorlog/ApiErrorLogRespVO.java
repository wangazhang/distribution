package com.hissp.distribution.module.infra.controller.admin.logger.vo.apierrorlog;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.hissp.distribution.module.system.enums.DictTypeConstants.USER_TYPE)
