package com.hissp.distribution.module.infra.service.codegen.inner;
...
import com.hissp.distribution.framework.apilog.core.enums.OperateTypeEnum;
...
import com.hissp.distribution.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.hissp.distribution.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.hissp.distribution.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.hissp.distribution.module.infra.enums.codegen.CodegenSceneEnum;
import com.hissp.distribution.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.hissp.distribution.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static final Map<String, String> SERVER_TEMPLATES = MapUtil.<String, String>builder(new LinkedHashMap<>()) // 有序
            ...
            .put(javaTemplatePath("adapter/controller/vo/pageReqVO"), javaModuleImplVOFilePath("PageReqVO"))
            .put(javaTemplatePath("adapter/controller/vo/listReqVO"), javaModuleImplVOFilePath("ListReqVO"))
            .put(javaTemplatePath("adapter/controller/vo/respVO"), javaModuleImplVOFilePath("RespVO"))
            .put(javaTemplatePath("adapter/controller/vo/saveReqVO"), javaModuleImplVOFilePath("SaveReqVO"))
            .put(javaTemplatePath("adapter/controller/controller"), javaModuleImplControllerFilePath())
            ...
            .put(javaTemplatePath("domain/service/serviceImpl"),
                    javaModuleImplMainFilePath("domain/service/${table.businessName}/${table.className}ServiceImpl"))
            .put(javaTemplatePath("domain/service/service"),
                    javaModuleImplMainFilePath("domain/service/${table.businessName}/${table.className}Service"))
            // Java module-biz Test
            .put(javaTemplatePath("test/serviceTest"),
                    javaModuleImplTestFilePath("domain/service/${table.businessName}/${table.className}ServiceImplTest"))
    ...
    private static String javaModuleImplVOFilePath(String path) {
        return javaModuleFilePath("adapter/controller/${sceneEnum.basePackage}/${table.businessName}/" +
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "distribution-module-${table.moduleName}/" + // 顶级模块
                "distribution-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "distribution-module-${table.moduleName}/" + // 顶级模块
                "distribution-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "distribution-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "distribution-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
