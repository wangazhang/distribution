package com.hissp.distribution.module.infra.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 图片文件夹 1-001-008-000 ==========
    ErrorCode IMAGE_FOLDER_NOT_EXISTS = new ErrorCode(1_001_008_000, "图片文件夹不存在");
    ErrorCode IMAGE_FOLDER_PATH_DUPLICATE = new ErrorCode(1_001_008_001, "图片文件夹路径已存在");
    ErrorCode IMAGE_FOLDER_HAS_CHILDREN = new ErrorCode(1_001_008_002, "图片文件夹存在子文件夹，无法删除");
    ErrorCode IMAGE_FOLDER_HAS_IMAGES = new ErrorCode(1_001_008_003, "图片文件夹中存在图片，无法删除");
    ErrorCode IMAGE_FOLDER_PARENT_CANNOT_BE_SELF = new ErrorCode(1_001_008_004, "不能设置自己为父文件夹");
    ErrorCode IMAGE_FOLDER_PARENT_CANNOT_BE_CHILD = new ErrorCode(1_001_008_005, "不能设置自己的子文件夹为父文件夹");

    // ========== 图片资源 1-001-009-000 ==========
    ErrorCode IMAGE_RESOURCE_NOT_EXISTS = new ErrorCode(1_001_009_000, "图片资源不存在");
    ErrorCode IMAGE_RESOURCE_UPLOAD_FAILED = new ErrorCode(1_001_009_001, "图片上传失败");
    ErrorCode IMAGE_RESOURCE_FORMAT_NOT_SUPPORTED = new ErrorCode(1_001_009_002, "不支持的图片格式");
    ErrorCode IMAGE_RESOURCE_SIZE_EXCEEDED = new ErrorCode(1_001_009_003, "图片大小超出限制");
