package com.hissp.distribution.module.bpm.service.task;
...
import com.hissp.distribution.framework.common.util.object.PageUtils;
import com.hissp.distribution.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.hissp.distribution.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.hissp.distribution.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.hissp.distribution.module.bpm.controller.admin.task.vo.instance.*;
import com.hissp.distribution.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.hissp.distribution.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.hissp.distribution.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.hissp.distribution.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.hissp.distribution.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.hissp.distribution.module.bpm.enums.ErrorCodeConstants;
import com.hissp.distribution.module.bpm.enums.definition.BpmModelTypeEnum;
import com.hissp.distribution.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.hissp.distribution.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.hissp.distribution.module.bpm.enums.task.BpmReasonEnum;
import com.hissp.distribution.module.bpm.enums.task.BpmTaskStatusEnum;
import com.hissp.distribution.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.hissp.distribution.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.hissp.distribution.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.hissp.distribution.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.hissp.distribution.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.hissp.distribution.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.hissp.distribution.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.hissp.distribution.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.hissp.distribution.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.hissp.distribution.module.bpm.service.definition.BpmProcessDefinitionService;
import com.hissp.distribution.module.bpm.service.message.BpmMessageService;
import com.hissp.distribution.module.system.api.dept.DeptApi;
import com.hissp.distribution.module.system.api.dept.dto.DeptRespDTO;
...
import static com.hissp.distribution.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.hissp.distribution.module.bpm.enums.ErrorCodeConstants.*;
import static com.hissp.distribution.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.hissp.distribution.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
