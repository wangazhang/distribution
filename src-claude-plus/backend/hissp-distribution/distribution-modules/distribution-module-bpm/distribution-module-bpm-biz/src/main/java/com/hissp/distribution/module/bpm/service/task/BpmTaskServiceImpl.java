...
import com.hissp.distribution.framework.datapermission.core.annotation.DataPermission;
import com.hissp.distribution.framework.web.core.util.WebFrameworkUtils;
import com.hissp.distribution.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.hissp.distribution.module.bpm.controller.admin.task.vo.task.*;
import com.hissp.distribution.module.bpm.convert.task.BpmTaskConvert;
import com.hissp.distribution.module.bpm.dal.dataobject.definition.BpmFormDO;
import com.hissp.distribution.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.hissp.distribution.module.bpm.enums.definition.*;
import com.hissp.distribution.module.bpm.enums.task.BpmCommentTypeEnum;
import com.hissp.distribution.module.bpm.enums.task.BpmReasonEnum;
import com.hissp.distribution.module.bpm.enums.task.BpmTaskSignTypeEnum;
...
import com.hissp.distribution.module.bpm.service.definition.BpmFormService;
import com.hissp.distribution.module.bpm.service.definition.BpmModelService;
...
import com.hissp.distribution.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static com.hissp.distribution.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static com.hissp.distribution.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_SKIP_START_USER_NODE;
import static com.hissp.distribution.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 distribution-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/distribution-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
