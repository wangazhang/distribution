package com.hissp.distribution.framework.quartz.core.scheduler;

import com.hissp.distribution.framework.quartz.core.enums.JobDataKeyEnum;
import com.hissp.distribution.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 https://doc.example.com/job/ 开启]");
        }
    }
