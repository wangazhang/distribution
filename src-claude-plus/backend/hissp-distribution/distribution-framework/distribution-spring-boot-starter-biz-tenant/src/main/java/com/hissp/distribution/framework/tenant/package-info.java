 ...
 *      1）Spring Async：
 *          {@link com.hissp.distribution.framework.quartz.config.DistributionAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 DistributionSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.hissp.distribution.framework.tenant;
