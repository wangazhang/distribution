...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hissp";
    private static final String ARTIFACT_ID = "distribution";
    private static final String PACKAGE_NAME = "com.hissp.distribution";
    private static final String TITLE = "distribution管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.hissp";
        String artifactIdNew = "distribution";
        String packageNameNew = "com.hissp.distribution";
        String titleNew = "distribution管理系统";
        String projectBaseDirNew = "/Users/qianzhang/Documents/03_work/06_yehu/02_项目/15_distribution/src/distribution-src/distribution-ai-code/src/backend/hissp-distribution"; // 一键改名后，“新”项目所在的目录
    ...
    private static Collection<File> listFiles(String projectBaseDir) {
        ...
        files = files.stream()
                .filter(file -> !file.getPath().contains(separator + "target" + separator)
                        ...
                        && !file.getPath().contains(separator + "docker" + separator+"mysql"+separator + "data" + separator)
